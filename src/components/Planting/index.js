    ...
    <>
      ...
      <div id="About">
        <p>
          ...
          As another example, if utilizing a no-til drill to plant cover crops select the appropriate equipment
          on the drop-down menu and proceed to answer questions on tractor horsepower.
        </p>
        <p>
          Also, the costs associated with machinery are dependent upon the annual hours of use.
          In this module you can accept the default value (for hours of annual use) or customize
          with the estimated hours associated with your operation.
      ...
      {
        dev && <button type="button" onClick={examplePlanting}>Test data</button>
      }
    </>
  );
}; // Planting
