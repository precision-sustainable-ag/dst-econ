  ...
  return (
    <div className="mobile-table-div">
      <div className="grid2">
        ...
        <div>
          <p>
            If you cash rent this field, will the landowner contribute to seed costs or other
            costs associated with planting cover crops?
          </p>
        ...
        <div>
          <p>
            Do you plan to participate in a state or federal program (e.g. USDA EQIP or USDA
            CSP) that provides financial assistance for using cover crops?
          </p>
          <p>
            If you click yes, an estimate of the NRCS EQIP state program (Practice 340) rate
            for your location and seeding mix is shown in the input box. You can change this
            financial assistance estimate to represent your specific opportunities.
            <Help>
              <p>
                The USDA NRCS provides financial assistance to some farms planting cover crops
                under Practice 340. The amount of financial assistance varies by state, cover
                crop practice and specific priorities.
              </p>
              <p>
                Priority programs include helping historically underserved audiences and water
                source protection. Financial assistance for planting multiple species is often
                greater than when planting a single species.
              </p>
              <p>
                The number of years that farms can receive cover crop financial assistance is
                usually limited.
              </p>
            </Help>
          </p>
          ...
          <p>
            ...
            <Help>
              ...
              <p>
                ...
                discount program administered by the Iowa Department of Agriculture and Land
                Stewardship and the USDA Risk Management Agency (RMA) when growers planted a
                fall seeded cover crop. Similar programs have been available in Illinois. Note
                that some insurance policies may be excluded (e.g. Whole-Farm Revenue
      ...
      <div className="mobile-table-div">
        <div className="grid2">
          ...
          <div className="colspan">
            ...
            opportunities with livestock operators in their area. The following question will
            help you evaluate the financial impact of grazing livestock.
          </div>
          ...
          */}
          ...
          <div>
            How much additional time (hours per acre) will be required for management of the
            grazing operation?
          </div>
          <div>
