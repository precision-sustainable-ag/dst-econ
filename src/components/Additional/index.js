    ...
    <div className="grid2">
      ...
      <div>
        ...
        <p>
          ...
          for your location and seeding mix is shown in the input box.
      ...
      <div>
        <p>
          Do you anticipate participation in a voluntary carbon offset program
          that will provide a payment based on carbon reducing practices such as cover crops?
        </p>
        <p>
      ...
      <div>
        ...
        <p>
          ...
          <Help>
            ...
            <p>
              For example, the State of Iowa has offered a $5 per acre crop insurance discount program
              administered by the Iowa Department of Agriculture and Land Stewardship and the USDA Risk Management Agency (RMA)
              when growers planted a fall seeded cover crop.
  ...
  return (
    <div className="Additional">
      ...
      <p>
        ...
        state program such as Soil &amp; Water Conservation Programs, federal programs such as EQIP (Environmental Quality Incentives Program)
        or CSP (Conservation Stewardship Program), or payments from companies aggregated voluntary carbon offsets.
